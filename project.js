...
$(function(){
    ...
    $("#rightPanel").on("keypress", "#missionEntry", function(e) {
    ...
    function handleEnterKey() {
        if (currentIndex === null) {
            console.error("currentIndex is not set.");
            return;
        }
    ...
    $(".mid span").on("click", function(){
        $(this).toggleClass("line-through") ; 
        let idx = $(this).index() ; 
        console.log(idx);

        tasks[idx].completed = $(this).hasClass("line-through")
        saveAllTasks() ;
    })
